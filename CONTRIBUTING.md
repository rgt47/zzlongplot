...
This outlines how to propose a change to zzlongplot. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("rgt47/zzlongplot", fork = TRUE)`.
...
Please note that the zzlongplot project is released with a [Contributor
Code of Conduct](https://rgt47.github.io/zzlongplot/CODE_OF_CONDUCT.md).
