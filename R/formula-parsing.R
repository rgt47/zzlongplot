...
parse_formula <- function(formula) {
  ...
  # Convert the formula to a single character string (handles long
  # formulas that deparse() would otherwise split across lines).
  formula_text <- paste(deparse(formula, width.cutoff = 500L),
                        collapse = " ")
