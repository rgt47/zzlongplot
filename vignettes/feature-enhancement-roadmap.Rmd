...
```{r demo_waterfall, eval=TRUE, fig.height=5, fig.width=8}
...
```{r demo_swimmer, eval=TRUE, fig.height=6, fig.width=10}
...
```{r demo_forest, eval=TRUE, fig.height=6, fig.width=10}
...
```{r demo_longitudinal, eval=TRUE, fig.height=5, fig.width=10}
