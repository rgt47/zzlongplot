...
Color alone is a fragile channel. A figure printed in
grayscale, photocopied, or read by someone with a color
...
color. It defaults to `TRUE` under `theme = "bw"` and
...
- Set `bw_print = TRUE` so line type and point shape carry the group
  as well as color, under whichever theme the figure uses
