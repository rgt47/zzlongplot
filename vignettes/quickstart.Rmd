...
```{r contrast-fn, eval=has_mmrm, fig.height=6, fig.cap="Figure 9: MMRM with contrast footnote."}
# Figure 9
lplot(two_arm,
  response ~ visit | treatment,
  baseline_value = 0,
...
```{r contrast-tbl, eval=has_mmrm, fig.height=7, fig.cap="Figure 10: MMRM with contrast table."}
# Figure 10
lplot(two_arm,
  response ~ visit | treatment,
  baseline_value = 0,
