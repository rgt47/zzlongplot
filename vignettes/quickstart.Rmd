...
The table has its own options: whether to name each row, whether to
keep the legend, and whether to take its vertical space from reserved
margin or from the panel. See
...
`lplot()` set, including the margin and legend the sample-size table
depends on.
...
| `sample_size_opts` | Placement of the N labels; see `vignette("sample-size-annotations")` | beside each point |
